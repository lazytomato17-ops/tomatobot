...
export async function handleInteraction(interaction: any) {
    ...
    const ignoreIds = ['vote_', 'thief_', 'divine_', 'strategy_', 'fakeresult_', 'guard_', 'kill_', 'sorcery_', 'devotee_', 'god_', 'necro_', 'dictator_', 'assassinate_', 'open_night_dashboard', 'open_fake_seer_menu', 'back_to_dashboard'];
