...
5. 直前の発言に反応して会話のキャッチボールを行うこと。
6. 【特殊コンビ】あなたが「サンズ」か「ジャックス」であり、会話ログに相方の発言があった場合、意気投合して便乗し、一緒に真面目な参加者の必死な様子を笑ったり煽ったりする「悪友」のような絡みをしてください。` 
        },
        { 
            role: 'user' as const, 
...
上記の「会話ログ」を読み取り、もし直前にCOや処刑などの事象があれば、真面目なキャラは全力で反応し、サンズやジャックスのようなふざけたキャラは事象を無視して雑談や煽りを入れるなど、あなたの個性を全開にしたチャットを発言してください。` 
        }
    ];
