...
export const ROLE_CATALOG: Record<string, { icon: string; team: 'villager' | 'wolf' | 'third'; isWolfCount?: boolean; description: string }> = {
    ...
    '共有者': { icon: '🔗', team: 'villager', description: '絶対に人間だと分かっている相棒がいます。裏で協力して村を導きましょう。' }, // 👥(連絡先)から🔗(絆)へ
    '検死官': { icon: '🔍', team: 'villager', description: '毎朝、昨晩襲撃されて死んだ人の「本当の役職」を知ることができます。' },
    '逃亡者': { icon: '💨', team: 'villager', description: '毎晩誰かの家へ逃げ込みます。逃げ込んだ先が人狼だったり襲撃されると死にます。' }, // 🏃‍♂️(ジョギング)から💨(ダッシュ)へ
    '怪盗': { icon: '🎩', team: 'villager', description: '初日の夜に、他の誰かと役職を交換することができます。' }, // 🕵️(探偵)から🎩(シルクハット)へ
    '市長': { icon: '👑', team: 'villager', description: 'あなたの投票は常に「2票分」としてカウントされます。' },
    'タフガイ': { icon: '❤️‍🩹', team: 'villager', description: '人狼に襲撃されても一度は耐え抜き、翌日の夜に遅れて死亡します。' }, // 💪(筋トレ)から❤️‍🩹(治療中)へ
    ...
    '死霊術師': { icon: '💀', team: 'villager', description: '一度だけ死者を蘇生できます。ただし、自分が死ぬと蘇生した相手も道連れになります。' }, // 🧟(ゾンビ)から💀(ドクロ)へ
    ...
    '狂人': { icon: '🎭', team: 'wolf', description: '人間ですが人狼の味方です。夜に「偽の占い」を行って村を混乱させましょう。' }, // 🤡(ピエロ)から🎭(仮面)へ
    '狂信者': { icon: '🕯️', team: 'wolf', description: '人間ですが、誰が人狼かを知っています。人狼を勝利させるために嘘をつきましょう。' }, // 👿(小悪魔)から🕯️(怪しい儀式)へ
    ...
    // 🌟 第三陣営
    '妖狐': { icon: '🦊', team: 'third', description: '襲撃されても死にませんが、占われると死にます。最後まで生き残れば単独勝利！' },
    'テルテル': { icon: '☔', team: 'third', description: '昼の投票で処刑されることが勝利条件です。怪しまれるように行動しましょう。' }, // 🃏(ジョーカー)から☔(てるてる坊主)へ
    'キューピッド': { icon: '🏹', team: 'third', description: '初日の夜に2人を「恋人」にします。恋人陣営として最後まで生き残れば勝利！' },
    '純愛者': { icon: '❤️‍🔥', team: 'third', description: '初日の夜に1人を「愛する人」にします。その人が勝利することがあなたの勝利条件です。' },
...
export const ROLE_SELECT_OPTIONS = [
    ...
    { label: '👻 霊能者', value: 'medium', description: '処刑された人の正体を知る' }, // やっぱり定番のオバケが一番わかりやすい！
    ...
    { label: '💨 逃亡者', value: 'fugitive', description: '毎晩誰かの家に逃げる（狼の家や襲撃先だと死ぬ）' },
    { label: '🎩 怪盗', value: 'thief', description: '初日の夜に誰かと役職を交換する' },
    { label: '💀 死霊術師', value: 'necromancer', description: '1度だけ死者を蘇生できるが、自分が死ぬと道連れになる' },
    ...
    { label: '🕊️ 神', value: 'god', description: '襲撃無効。特定の条件で単独・共存勝利' }
];